<script>
	...
	import { $createHeadingNode as _createHeadingNode, $createQuoteNode as _createQuoteNode } from '@lexical/rich-text';
	import { $createParagraphNode as _createParagraphNode, $createTextNode as _createTextNode, $getRoot as _getRoot } from 'lexical';
